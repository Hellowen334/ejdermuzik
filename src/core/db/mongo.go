...
func InitDatabase() error {
	...
	Instance = &Database{
		...
		fileCacheDB: db.Collection("cached_files"),
...
func (db *Database) SaveCachedFileID(ctx context.Context, trackID string, isVideo bool, fileID string, messageID int32) error {
	format := "audio"
	if isVideo {
		format = "video"
	}
